...
svet <- uvozi.zemljevid("http://biogeo.ucdavis.edu/data/gadm2.8/gadm28.shp.zip",mapa = "gadm28.shp",pot.zemljevida = "gadm28.shp",
                        encoding = "UTF-8", force = FALSE)
drzave <- read.csv("podatki/zdruzeni2.csv")
row.names(drzave) <- drzave$Drzava
drzave <- preuredi(drzave,svet,"Drzava")